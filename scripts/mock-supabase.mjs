...
const db = {
  ...
  documents: [
    { id: 1, module: 'anatomie', chapter: 1, where_shown: 'archive', section: 'lecture', n: '4',
      ...
      drive_id: '1MockDriveIdAAAAAAAAAAAAAAAAAAAAA', published: true, position: 0 },
  ...
  questions: [
    ...
    // Five propositions, one or more right — the way FMPOS examines.
    { id: 2, bank: 1, n: '2', stem: "Concernant le nerf facial (VII) :",
      options: ['Il émerge du sillon bulbo-pontique', 'Il pénètre dans le méat acoustique interne',
        'Il sort du crâne par le foramen stylo-mastoïdien', 'Il innerve les muscles masticateurs', 'Il traverse le foramen ovale'],
    ...
    { id: 10, bank: 1, n: '3', stem: "Concernant l'artère carotide interne :",
      options: ['Elle naît de la bifurcation de la carotide commune', 'Elle traverse le canal carotidien',
        'Elle donne des branches collatérales au cou', 'Elle traverse le sinus caverneux', "Elle se termine en artère basilaire"],
      answer: [0, 1, 3], why: null, source: 'paper', status: 'published' },
    { id: 11, bank: 1, n: '4', stem: "Concernant l'artère vertébrale :",
      options: ["Elle naît de l'artère subclavière", 'Elle chemine dans les foramens transversaires',
        'Elle pénètre dans le crâne par le foramen magnum', "Elle donne l'artère ophtalmique",
        "Les deux artères vertébrales s'unissent en artère basilaire"],
      answer: [0, 1, 2, 4], why: null, source: 'paper', status: 'published' },
    { id: 12, bank: 1, n: '5', stem: "Concernant l'os pariétal :",
      options: ['C’est un os pair', 'Il appartient à la calvaria', 'Il présente le foramen magnum',
        "Il s'articule avec l'os frontal par la suture coronale", 'Il forme le pôle antérieur du crâne'],
      answer: [0, 1, 3], why: null, source: 'paper', status: 'published' },
  ...
  posts: [
    ...
    { id: 503, promo: 'pcem2', author: 'u-4', module: 'physiologie', kind: 'note',
      body: 'Résumé du potentiel d’action — les trois phases في صفحة واحدة.',
      likes: 14, comments: 0, removed: false, created_at: '2026-09-07T19:05:00Z' },
    { id: 504, promo: 'pcem2', author: 'u-4', module: 'biochimie', kind: 'note',
      body: 'Glycolyse : les 10 étapes مع الإنزيمات.',
      likes: 9, comments: 0, removed: false, created_at: '2026-09-06T21:30:00Z' },
    { id: 505, promo: 'pcem2', author: 'u-5', module: 'histologie', kind: 'note',
      body: 'Tissu épithélial — جدول المقارنة.',
      likes: 6, comments: 0, removed: false, created_at: '2026-09-06T17:00:00Z' },
    { id: 506, promo: 'pcem2', author: 'u-6', module: null, kind: 'question',
      body: 'أحد عنده QCM Embryologie 2024 ؟',
      likes: 2, comments: 0, removed: false, created_at: '2026-09-06T12:20:00Z' },
    { id: 507, promo: 'pcem2', author: 'u-owner', module: 'anatomie', kind: 'note',
      body: 'Plexus brachial — schéma مبسّط.',
      likes: 8, comments: 0, removed: false, created_at: '2026-09-05T20:10:00Z' },
    { id: 508, promo: 'pcem2', author: 'u-7', module: null, kind: 'text',
      body: 'غرفة دراسة الليلة الساعة 9 لمراجعة Biophysique.',
      likes: 3, comments: 0, removed: false, created_at: '2026-09-05T15:00:00Z' },
  ],
