  ...
  chapters: [
    {
      ...
      lectures: [
        // Promo 19's own slides, 2025 — the current cohort's version of the
        // lecture. The older copy from the shared Drive hangs off it rather
        // than sitting beside it as more material.
        { n: 1, title: 'Anatomie générale', ext: P, mb: '5.8', year: 2025, prof: 'Limam',
          fid: '1CK3drIvdQsyDywAfDMXB895dvtA6QivW',
          versions: [
            { title: 'Anatomie générale', ext: P, mb: '1.3', year: 2023,
  ...
  sections: [
    {
      id: 'examens', where: 'quiz', title: 'Examens', icon: 'quiz',
      items: [
        // Two copies in the Drive, a few kilobytes apart — the same
        // compilation scanned twice, not the same file twice, so the second
        // is kept as another version rather than thrown away.
        { title: 'Tous les examens — Pr Kébé', ext: P, mb: '5.3', year: 2023,
          fid: '1eghz75EAPClFDkwQHhPOA6TYIRwM4tXq',
          versions: [
            { title: 'Tous les examens — Pr Kébé (autre copie)', ext: P, mb: '5.3', year: 2022,
              fid: '1tIavwRwjh6V3DtK5AsjPyJBZSWEmKpFH' },
          ] },
