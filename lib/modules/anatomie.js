...
export const ANATOMIE = {
  ...
  // Everything that is not a lecture, filed by what it is — and then by where
  // in the app it belongs. The archive keeps the slides, the polycopiés and the
  // schémas. Résumés and student notes are الملخصات. Exams, isolés and QCM
  // banks are question material, so they belong to اختبر نفسك, not here.
  sections: [
    {
    ...
    {
      id: 'qcm', where: 'quiz', title: 'Banques de QCM', icon: 'quiz',
      items: [
