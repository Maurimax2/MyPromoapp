...
export const BUNDLES = [
...

  {
    ...
    tissue: 'muscle',
    // The one bone in a bundle of muscles, and it must not come out red.
    tissues: { Os: 'bone' },
...

  {
    ...
    // Arteries, veins and dural sinuses in one model. Painting them one
    // colour would throw away the first thing a student reads off a plate.
    tissue: 'artery',
    tissues: { Veines: 'vein', 'Sinus de la dure-mère': 'sinus' },
...

  {
    ...
    tissue: 'bone',
    tissues: {
      'Squelette laryngé': 'cartilage',
      'Disques intervertébraux': 'disc',
      Ligaments: 'tendon',
    },
...

  {
    ...
    tissue: 'grey',
    tissues: {
      'Système ventriculaire': 'csf',
      'Voies optiques': 'nerve',
      Commissures: 'brain',
    },
...

  {
    ...
    tissue: 'brain',
    tissues: { 'Système ventriculaire': 'csf' },
...

  {
    ...
    tissue: 'bone',
    tissues: { 'Cartilages costaux': 'cartilage', Diaphragme: 'muscle' },
...

  {
    ...
    tissue: 'heart',
    tissues: {
      'Gros vaisseaux': 'artery',
      'Artères coronaires': 'artery',
      'Veines cardiaques': 'vein',
    },
...

  {
    ...
    tissue: 'lung',
    tissues: { 'Voies aériennes': 'cartilage', 'Bronches lobaires': 'cartilage' },
...

  {
    ...
    tissues: {
      Foie: 'liver',
      'Voies biliaires': 'gland',
      'Glandes annexes': 'gland',
    },
...

  {
    ...
    tissue: 'kidney',
    tissues: {
      'Voies excrétrices': 'urine',
      'Glandes surrénales': 'gland',
      Gonades: 'gonad',
      'Organes érectiles': 'erectile',
      'Appareil génital': 'gland',
    },
