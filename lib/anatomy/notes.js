...
export const NOTES = {
  crane: {
    ...
    // ------------------------------------------------ les reliefs du crâne
    //
    // A landmark is described like anything else: what it is, and the one
    // thing about it a student is actually asked.

    'Bosse frontale': {
      what: `Le point le plus saillant de l'écaille frontale, de part et
        d'autre de la ligne médiane. C'est un centre d'ossification de l'os.`,
      note: 'Les deux bosses frontales sont plus marquées chez l’enfant.',
    },
    'Arcade sourcilière': {
      what: `Le relief transversal au-dessus de l'orbite, entre la glabelle et
        le processus zygomatique du frontal.`,
      note: `Elle recouvre le sinus frontal. Son développement est un caractère
        sexuel du crâne : plus marquée chez l'homme.`,
    },
    Nasion: {
      what: `Le point médian de la suture fronto-nasale, à la racine du nez.
        Point craniométrique de référence.`,
      note: 'C’est le repère antérieur du plan de Francfort en céphalométrie.',
    },
    Bregma: {
      what: `Le point de rencontre de la suture coronale et de la suture
        sagittale, au sommet du crâne et en avant.`,
      note: `C'est la fontanelle antérieure du nouveau-né, qui se ferme vers
        dix-huit mois. Sa tension est un signe d'hypertension intracrânienne
        chez le nourrisson.`,
    },
    Vertex: {
      what: `Le point le plus élevé du crâne, sur la ligne médiane, le crâne
        étant orienté dans le plan de Francfort.`,
    },
    Lambda: {
      what: `Le point de rencontre de la suture sagittale et de la suture
        lambdoïde, en arrière et en haut.`,
      note: 'C’est la fontanelle postérieure, qui se ferme vers deux mois.',
    },
    'Angle mastoïdien du pariétal': {
      what: `L'angle postéro-inférieur du pariétal, où il rejoint le temporal
        et l'occipital.`,
      note: `C'est l'astérion, où se rencontrent pariétal, temporal et
        occipital. Il répond au sinus sigmoïde en dedans.`,
    },
    'Angle sphénoïdal du pariétal': {
      what: `L'angle antéro-inférieur du pariétal, où il rejoint le frontal, le
        temporal et la grande aile du sphénoïde.`,
      note: `C'est le ptérion, le point le plus mince de la voûte. L'artère
        méningée moyenne y chemine juste en dedans : un choc temporal qui le
        fracture donne un hématome extra-dural.`,
    },
    'Ligne temporale': {
      what: `Une crête courbe sur la face externe du pariétal, qui limite en
        haut l'insertion du muscle temporal.`,
      muscles: ['Temporal, sur la ligne inférieure', 'Fascia temporal, sur la ligne supérieure'],
    },
    'Ligne nuchale supérieure': {
      what: `Une crête transversale de l'écaille occipitale, de part et d'autre
        de la protubérance occipitale externe.`,
      muscles: ['Trapèze', 'Sterno-cléido-mastoïdien', 'Splénius de la tête',
        'Occipital (ventre occipital de l’occipito-frontal)'],
    },
    Clivus: {
      what: `La gouttière oblique formée par la partie basilaire de l'occipital
        et le corps du sphénoïde, en avant du foramen magnum.`,
      near: ['Tronc cérébral, qui repose dessus', 'Tronc basilaire, dans le sillon'],
      note: 'Le pont est appliqué contre lui : une fracture du clivus est une lésion du tronc.',
    },
    Basion: {
      what: `Le milieu du bord antérieur du foramen magnum. Point
        craniométrique de la base.`,
      note: `La ligne basion-opisthion mesure le diamètre antéro-postérieur du
        foramen magnum, et l'écart basion–dent de l'axis dépiste une
        dissociation atlanto-occipitale.`,
    },
    Opisthion: {
      what: `Le milieu du bord postérieur du foramen magnum, en face du
        basion.`,
    },
    'Processus styloïde': {
      what: `Un long stylet osseux qui descend de la face inférieure du
        temporal, en avant et en dedans du processus mastoïde.`,
      muscles: ['Stylo-hyoïdien', 'Stylo-glosse', 'Stylo-pharyngien',
        'Ligaments stylo-hyoïdien et stylo-mandibulaire'],
      note: `Les trois muscles et les deux ligaments forment le bouquet de
        Riolan. Son allongement donne le syndrome d'Eagle.`,
    },
    'Fosse mandibulaire': {
      what: `La cavité de la face inférieure du temporal, en avant du méat
        acoustique externe, qui reçoit le condyle de la mandibule.`,
      joints: ['Condyle mandibulaire, par l’articulation temporo-mandibulaire'],
      note: `Son toit est très mince et la répond à la fosse crânienne
        moyenne : un choc sur le menton peut y enfoncer le condyle.`,
    },
    'Tubercule articulaire': {
      what: `La saillie transversale en avant de la fosse mandibulaire, sur
        laquelle le condyle glisse pendant l'ouverture de la bouche.`,
      note: `C'est par-dessus lui que le condyle passe dans la luxation
        antérieure de la mandibule — la bouche reste ouverte.`,
    },
    'Méat acoustique externe': {
      what: `L'orifice externe du conduit auditif, sur la face latérale du
        temporal, entre le processus zygomatique et le processus mastoïde.`,
      near: ['Fosse mandibulaire, en avant', 'Processus mastoïde, en arrière'],
      note: 'Son bord supérieur est le repère postérieur du plan de Francfort.',
    },
    'Apex du rocher': {
      what: `L'extrémité antéro-médiale de la partie pétreuse du temporal, qui
        s'avance vers le corps du sphénoïde.`,
      near: ['Foramen déchiré, entre l’apex, le sphénoïde et l’occipital',
        'Canal carotidien, dont l’orifice interne s’ouvre ici'],
    },
    'Processus clinoïde antérieur': {
      what: `La pointe postérieure de la petite aile du sphénoïde, qui borde la
        selle turcique en avant.`,
      near: ['Artère carotide interne, à sa sortie du sinus caverneux',
        'Nerf optique, en dedans'],
      note: 'Il est fraisé pour aborder les anévrismes de la carotide intra-caverneuse.',
    },
    'Petite aile du sphénoïde': {
      what: `La lame triangulaire qui part du corps du sphénoïde en haut et en
        dehors, et sépare l'étage antérieur de l'étage moyen.`,
      joints: ['Os frontal, en avant'],
      through: ['Canal optique, à sa racine — nerf optique et artère ophtalmique'],
      note: `Son bord postérieur libre est la limite entre les deux étages, et
        c'est contre lui que le pôle temporal vient buter dans un traumatisme.`,
    },
    'Épine du sphénoïde': {
      what: `La pointe qui descend de l'angle postérieur de la grande aile, en
        dedans et en arrière du foramen épineux.`,
      muscles: ['Ligament sphéno-mandibulaire', 'Tenseur du voile du palais'],
      near: ['Nerf auriculo-temporal et artère méningée moyenne, en dedans'],
    },
    'Hamulus ptérygoïdien': {
      what: `Le petit crochet qui termine la lame médiale du processus
        ptérygoïde, en bas.`,
      muscles: ['Tenseur du voile du palais, dont le tendon s’y réfléchit à angle droit'],
      note: 'C’est une poulie de renvoi : le muscle tire horizontalement et le tendon descend.',
    },
    'Épine nasale antérieure': {
      what: `La pointe médiane à la base de l'ouverture piriforme, formée par
        les deux maxillaires.`,
      note: 'Point craniométrique, et repère de la chirurgie de la cloison.',
    },
    'Tubérosité maxillaire': {
      what: `La saillie arrondie de la face postérieure du maxillaire, derrière
        la dernière molaire.`,
      near: ['Fosse ptérygo-palatine, en arrière', 'Muscle ptérygoïdien médial'],
      through: ['Foramens alvéolaires postérieurs — nerfs et vaisseaux alvéolaires supérieurs postérieurs'],
    },
    'Processus palatin': {
      what: `La lame horizontale qui part de la face médiale du maxillaire et
        forme les deux tiers antérieurs du palais osseux.`,
      joints: ['Processus palatin opposé, par la suture palatine médiane',
        'Lame horizontale du palatin, en arrière'],
      note: 'Son défaut de fusion est la fente palatine.',
    },
    'Incisure mandibulaire': {
      what: `L'échancrure du bord supérieur de la branche, entre le processus
        coronoïde en avant et le processus condylaire en arrière.`,
      through: ['Nerf et vaisseaux massétérins, vers le muscle masséter'],
    },
    'Lingula (épine de Spix)': {
      what: `La petite pointe osseuse qui borde en avant et en dedans le
        foramen mandibulaire, sur la face médiale de la branche.`,
      muscles: ['Ligament sphéno-mandibulaire'],
      note: `C'est le repère de l'anesthésie tronculaire du nerf alvéolaire
        inférieur : l'aiguille est placée juste en arrière.`,
    },
    'Symphyse mentonnière': {
      what: `La ligne médiane de la face antérieure du corps mandibulaire,
        vestige de la soudure des deux hémi-mandibules.`,
      muscles: ['Génio-glosse et génio-hyoïdien, sur les épines mentonnières en dedans',
        'Muscles du menton, en avant'],
    },
    'Processus maxillaire du zygomatique': {
      what: `La partie du zygomatique qui s'articule avec le maxillaire et
        forme le rebord infra-orbitaire latéral.`,
      joints: ['Maxillaire'],
    },
    'Épine nasale postérieure': {
      what: `La pointe médiane du bord postérieur du palais osseux, formée par
        les deux lames horizontales des palatins.`,
      muscles: ['Muscle uvulaire', 'Aponévrose palatine'],
    },
    'Lame perpendiculaire du palatin': {
      what: `La lame verticale du palatin, appliquée contre la face médiale du
        maxillaire, qui forme une partie de la paroi latérale des fosses
        nasales.`,
      through: ['Canal grand palatin — nerf et vaisseaux grands palatins'],
    },
    'Crista galli': {
      what: `La crête verticale et médiane qui se dresse sur la lame criblée de
        l'ethmoïde, dans l'étage antérieur.`,
      muscles: ['Faux du cerveau, qui s’y insère en avant'],
      near: ['Lame criblée et bulbes olfactifs, de chaque côté'],
    },
    'Cornet nasal moyen': {
      what: `La lame enroulée qui descend du labyrinthe ethmoïdal dans la
        cavité nasale. Il fait partie de l'ethmoïde, contrairement au cornet
        inférieur.`,
      near: ['Méat moyen, en dessous, où s’ouvrent les sinus maxillaire, frontal et ethmoïdal antérieur'],
      note: `Le méat moyen est le carrefour de drainage de trois sinus : c'est
        pourquoi il est la cible de la chirurgie endoscopique.`,
    },
    'Bord postérieur du vomer': {
      what: `Le bord libre et postérieur du vomer, qui sépare les deux
        choanes.`,
      near: ['Choanes, de chaque côté', 'Pharynx nasal, en arrière'],
    },
    'Bord libre du cornet inférieur': {
      what: `Le bord inférieur, libre, du cornet nasal inférieur — le seul
        cornet qui soit un os à part entière.`,
      near: ['Méat inférieur, en dessous, où s’ouvre le conduit lacrymo-nasal'],
    },
    'Sillon lacrymal': {
      what: `La gouttière verticale de l'os lacrymal qui, avec le maxillaire,
        forme la fosse du sac lacrymal.`,
      near: ['Sac lacrymal', 'Conduit lacrymo-nasal, qui descend vers le méat inférieur'],
    },
...
NOTES.rachis = {
  'Tubercule antérieur de l’atlas': {
    what: `La petite saillie médiane de la face antérieure de l'arc antérieur
      de l'atlas.`,
    muscles: ['Long du cou', 'Long de la tête'],
  },
  'Tubercule postérieur de l’atlas': {
    what: `Le vestige de processus épineux de l'atlas, sur la face postérieure
      de l'arc postérieur.`,
    muscles: ['Petit droit postérieur de la tête', 'Ligament nuchal'],
  },
  'Sillon de l’artère vertébrale': {
    what: `La gouttière de la face supérieure de l'arc postérieur de l'atlas,
      derrière la masse latérale.`,
    through: ['Artère vertébrale, après sa sortie du foramen transversaire de C1',
      'Premier nerf cervical'],
    note: `C'est ici que l'artère quitte le rachis pour percer la membrane
      atlanto-occipitale. Sa blessure est le risque des vis de C1.`,
  },
  'Processus transverse gauche de l’atlas': {
    what: `Le processus transverse le plus long du rachis cervical, palpable
      entre le processus mastoïde et l'angle de la mandibule.`,
    muscles: ['Élévateur de la scapula', 'Oblique supérieur et inférieur de la tête'],
    note: 'C’est le seul processus transverse cervical réellement palpable.',
  },
  'Apex de la dent de l’axis': {
    what: `Le sommet du processus odontoïde, qui monte du corps de l'axis dans
      l'anneau de l'atlas.`,
    muscles: ['Ligament apical de la dent', 'Ligaments alaires'],
    note: `L'écart entre la dent et le basion se mesure sur toute radiographie
      de rachis cervical traumatique.`,
  },
  'Facette articulaire antérieure de la dent': {
    what: `La surface articulaire de la face antérieure de la dent, qui répond
      à la fossette de l'arc antérieur de l'atlas.`,
    joints: ['Arc antérieur de l’atlas, par l’articulation atlanto-axoïdienne médiane'],
    note: `C'est l'articulation du « non » : la rotation de la tête se fait
      ici, et le ligament transverse la maintient par derrière.`,
  },
  'Processus épineux de l’axis': {
    what: `L'épineuse de C2, épaisse et bifide, la première palpable sous
      l'occiput.`,
    muscles: ['Grand droit postérieur de la tête', 'Oblique inférieur de la tête'],
  },
  'Uncus gauche de C4': {
    what: `La crête relevée du bord latéral du plateau supérieur d'une vertèbre
      cervicale.`,
    joints: ['Vertèbre sus-jacente, par l’articulation unco-vertébrale de Luschka'],
    note: `L'arthrose unco-vertébrale rétrécit le foramen intervertébral : c'est
      la cause la plus fréquente de névralgie cervico-brachiale après la hernie.`,
  },
  'Foramen transversaire gauche de C4': {
    what: `Le canal qui perce le processus transverse de chaque vertèbre
      cervicale — le caractère qui définit une vertèbre cervicale.`,
    through: ['Artère et veine vertébrales, de C6 à C1'],
    note: `Aucune autre vertèbre du corps n'en a. L'artère entre à C6, pas à
      C7 : le foramen de C7 ne livre passage qu'à la veine.`,
  },
  'Tubercule carotidien (de Chassaignac)': {
    what: `Le tubercule antérieur, très saillant, du processus transverse de
      C6.`,
    near: ['Artère carotide commune, juste en avant'],
    note: `On comprime la carotide contre lui. Il marque aussi le niveau C6 :
      le pharynx devient œsophage et le larynx devient trachée.`,
  },
  'Processus épineux de C7 (vertèbre proéminente)': {
    what: `L'épineuse de C7, longue, horizontale et non bifide, qui fait la
      saillie palpable à la base du cou.`,
    muscles: ['Ligament nuchal, qui s’y termine', 'Trapèze', 'Rhomboïde mineur'],
    note: 'C’est le point de départ du comptage des épineuses.',
  },
  'Corps de l’os hyoïde': {
    what: `La partie antérieure et quadrilatère de l'hyoïde, palpable au-dessus
      du cartilage thyroïde.`,
    muscles: ['Mylo-hyoïdien et génio-hyoïdien, en haut',
      'Sterno-hyoïdien et omo-hyoïdien, en bas'],
    note: 'Il se projette en regard de C3.',
  },
  'Grande corne gauche de l’hyoïde': {
    what: `Le prolongement postérieur et latéral du corps de l'hyoïde.`,
    muscles: ['Constricteur moyen du pharynx', 'Hyo-glosse', 'Ligament thyro-hyoïdien latéral'],
    note: `Son extrémité est le repère du nerf hypoglosse et de l'artère
      linguale dans le triangle de Béclard.`,
  },
  'Petite corne gauche de l’hyoïde': {
    what: `La petite saillie qui monte à la jonction du corps et de la grande
      corne.`,
    muscles: ['Ligament stylo-hyoïdien, qui la relie au processus styloïde'],
  },
  'Proéminence laryngée (pomme d’Adam)': {
    what: `L'angle antérieur où se rejoignent les deux lames du cartilage
      thyroïde, saillant sous la peau.`,
    note: `L'angle est plus aigu chez l'homme, ce qui rend la saillie visible.
      Elle se projette en regard de C4-C5.`,
  },
  'Incisure thyroïdienne supérieure': {
    what: `L'échancrure en V du bord supérieur du cartilage thyroïde,
      au-dessus de la proéminence laryngée.`,
    note: 'C’est le repère médian le plus fiable du larynx à la palpation.',
  },
  'Corne supérieure gauche du thyroïde': {
    what: `Le prolongement supérieur du bord postérieur de la lame thyroïdienne,
      relié à l'hyoïde.`,
    muscles: ['Ligament thyro-hyoïdien latéral'],
    near: ['Nerf laryngé supérieur, dont la branche interne perce la membrane juste devant'],
  },
  'Corne inférieure gauche du thyroïde': {
    what: `Le prolongement inférieur du bord postérieur de la lame, qui
      s'articule avec le cricoïde.`,
    joints: ['Cartilage cricoïde, par l’articulation crico-thyroïdienne'],
    note: `C'est le pivot de la mise en tension des cordes vocales par le
      muscle crico-thyroïdien.`,
  },
  'Ligne oblique': {
    what: `La crête oblique de la face externe de chaque lame thyroïdienne.`,
    muscles: ['Thyro-hyoïdien', 'Sterno-thyroïdien', 'Constricteur inférieur du pharynx'],
  },
  'Arc du cricoïde': {
    what: `La partie antérieure, étroite, de l'anneau cricoïdien, palpable sous
      le cartilage thyroïde.`,
    note: `Le cricoïde est le seul anneau complet de toute la voie aérienne :
      c'est sur lui que se fait la manœuvre de Sellick.`,
  },
  'Lame (chaton) du cricoïde': {
    what: `La partie postérieure, haute, de l'anneau cricoïdien, qui lui donne
      sa forme de chevalière.`,
    joints: ['Cartilages aryténoïdes, sur son bord supérieur'],
    near: ['Œsophage, juste en arrière'],
  },
  'Bord supérieur de l’arc cricoïdien': {
    what: `Le bord supérieur de l'arc du cricoïde, d'où monte la membrane
      crico-thyroïdienne vers le cartilage thyroïde.`,
    note: `La membrane elle-même est entre deux cartilages et n'a pas de
      géométrie propre ici. C'est juste au-dessus de ce bord que se fait la
      cricothyroïdotomie, l'accès d'urgence aux voies aériennes.`,
  },
...
NOTES['membre-sup'] = {
  // -------------------------------------------------- les reliefs des os
  //
  // A landmark is described like anything else: what it is, and the one thing
  // about it a student is actually asked.

  Acromion: {
    what: `Le prolongement latéral de l'épine de la scapula, qui coiffe
      l'articulation scapulo-humérale et forme le sommet de l'épaule.`,
    joints: ['Clavicule, par l’articulation acromio-claviculaire'],
    muscles: ['Deltoïde, faisceau acromial', 'Trapèze'],
    note: `C'est sous lui que passe le tendon du supra-épineux : le conflit
      sous-acromial est le mécanisme de l'épaule douloureuse.`,
  },
  'Processus coracoïde': {
    what: `Une apophyse en bec de corbeau qui part du col de la scapula et se
      recourbe en avant et en dehors.`,
    muscles: ['Petit pectoral', 'Coraco-brachial', 'Courte portion du biceps brachial',
      'Ligaments coraco-claviculaires et coraco-acromial'],
    note: 'Trois muscles et trois ligaments : c’est le phare de l’épaule.',
  },
  'Cavité glénoïdale': {
    what: `La surface articulaire ovalaire de l'angle latéral de la scapula,
      beaucoup plus petite que la tête humérale qu'elle reçoit.`,
    joints: ['Tête humérale'],
    note: `Elle ne couvre qu'un quart de la tête : c'est ce qui donne à
      l'épaule sa mobilité et son instabilité. Le bourrelet glénoïdal
      l'agrandit, et sa désinsertion est la lésion de Bankart.`,
  },
  'Épine de la scapula': {
    what: `La crête oblique de la face postérieure de la scapula, qui sépare la
      fosse supra-épineuse de la fosse infra-épineuse.`,
    muscles: ['Trapèze, sur son bord supérieur', 'Deltoïde, sur son bord inférieur'],
  },
  'Angle inférieur de la scapula': {
    what: `La pointe inférieure de la scapula, palpable sous la peau, en regard
      de la septième côte.`,
    muscles: ['Grand dorsal, par quelques fibres', 'Grand rond'],
    note: 'C’est le repère du bord inférieur de l’auscultation pulmonaire postérieure.',
  },
  'Angle supérieur de la scapula': {
    what: `L'angle médial et supérieur de la scapula, en regard de la deuxième
      côte.`,
    muscles: ['Élévateur de la scapula'],
  },
  'Bord médial de la scapula': {
    what: `Le bord vertical et interne de la scapula, parallèle aux processus
      épineux, à cinq centimètres d'eux.`,
    muscles: ['Rhomboïdes majeur et mineur', 'Dentelé antérieur, sur sa face costale'],
    note: `Son décollement est le scapula alata : le dentelé antérieur ne
      plaque plus la scapula contre le thorax.`,
  },
  'Bord latéral de la scapula': {
    what: `Le bord épais qui descend de la cavité glénoïdale à l'angle
      inférieur, du côté de l'aisselle.`,
    muscles: ['Petit rond, en haut', 'Grand rond, en bas'],
  },
  'Extrémité sternale de la clavicule': {
    what: `L'extrémité médiale, renflée, qui s'articule avec le manubrium.`,
    joints: ['Manubrium sternal, par l’articulation sterno-claviculaire'],
    note: 'C’est la seule articulation entre le membre supérieur et le squelette axial.',
  },
  'Extrémité acromiale de la clavicule': {
    what: `L'extrémité latérale, aplatie, qui s'articule avec l'acromion.`,
    joints: ['Acromion'],
    note: `Sa luxation est la disjonction acromio-claviculaire, avec le signe
      de la touche de piano.`,
  },
  'Tubercule conoïde': {
    what: `Une saillie de la face inférieure du tiers latéral de la clavicule,
      où s'attache le ligament conoïde.`,
    muscles: ['Ligament conoïde, et la ligne trapézoïde en dehors de lui'],
    note: `Les deux ligaments coraco-claviculaires suspendent le membre à la
      clavicule : leur rupture est ce qui fait la disjonction de stade III.`,
  },
  'Sillon du subclavier': {
    what: `La gouttière de la face inférieure du corps de la clavicule, où se
      loge le muscle subclavier.`,
    muscles: ['Subclavier'],
    near: ['Plexus brachial et artère subclavière, juste en dessous'],
  },

  'Tête humérale': {
    what: `Le tiers de sphère, orienté en haut, en dedans et en arrière, qui
      s'articule avec la cavité glénoïdale.`,
    joints: ['Cavité glénoïdale de la scapula'],
    note: `Sa vascularisation vient des artères circonflexes, qui remontent le
      long du col : une fracture du col anatomique la prive de sang.`,
  },
  'Tubercule majeur (trochiter)': {
    what: `La saillie latérale de l'extrémité supérieure de l'humérus, à trois
      facettes.`,
    muscles: ['Supra-épineux, sur la facette supérieure',
      'Infra-épineux, sur la facette moyenne', 'Petit rond, sur la facette inférieure'],
    note: 'Trois des quatre muscles de la coiffe s’y insèrent ; le quatrième va au trochin.',
  },
  'Tubercule mineur (trochin)': {
    what: `La saillie antérieure de l'extrémité supérieure de l'humérus, en
      dedans de la coulisse bicipitale.`,
    muscles: ['Subscapulaire'],
  },
  'Sillon intertuberculaire (coulisse bicipitale)': {
    what: `La gouttière verticale entre les deux tubercules, dans laquelle
      glisse le tendon de la longue portion du biceps.`,
    through: ['Tendon de la longue portion du biceps brachial'],
    muscles: ['Grand pectoral, sur la lèvre latérale',
      'Grand rond, sur la lèvre médiale', 'Grand dorsal, dans le fond'],
    note: 'La ténosynovite du long biceps est une douleur exactement ici.',
  },
  'Col chirurgical': {
    what: `Le rétrécissement de la diaphyse juste sous les deux tubercules. Il
      porte ce nom parce que c'est là que l'humérus se casse.`,
    near: ['Nerf axillaire et artère circonflexe postérieure, qui le contournent'],
    note: `Sa fracture lèse le nerf axillaire : le moignon de l'épaule devient
      insensible et le deltoïde ne fonctionne plus.`,
  },
  'Tubérosité deltoïdienne': {
    what: `La rugosité en V de la face latérale de la diaphyse humérale, à
      mi-hauteur.`,
    muscles: ['Deltoïde'],
  },
  'Sillon du nerf radial': {
    what: `La gouttière oblique de la face postérieure de la diaphyse, qui
      descend de haut en bas et de dedans en dehors.`,
    through: ['Nerf radial et artère brachiale profonde'],
    note: `Une fracture de la diaphyse à ce niveau donne la main tombante :
      c'est la paralysie radiale des fractures de l'humérus.`,
  },
  'Épicondyle médial (épitrochlée)': {
    what: `La saillie médiale de l'extrémité inférieure de l'humérus, très
      palpable sous la peau.`,
    muscles: ['Épicondyliens médiaux : les fléchisseurs et les pronateurs'],
    near: ['Nerf ulnaire, dans le sillon juste derrière lui'],
    note: `Le nerf ulnaire y est sous-cutané : c'est le « petit juif », et
      c'est le site le plus fréquent de sa compression.`,
  },
  'Épicondyle latéral': {
    what: `La saillie latérale de l'extrémité inférieure de l'humérus, plus
      petite que la médiale.`,
    muscles: ['Épicondyliens latéraux : les extenseurs et le supinateur'],
    note: 'Sa tendinite d’insertion est l’épicondylite, le tennis elbow.',
  },
  'Trochlée humérale': {
    what: `La poulie de l'extrémité inférieure de l'humérus, en dedans, qui
      reçoit l'incisure trochléaire de l'ulna.`,
    joints: ['Ulna, par l’articulation huméro-ulnaire'],
    note: 'C’est une trochléenne pure : flexion-extension et rien d’autre.',
  },
  Capitulum: {
    what: `La demi-sphère latérale de l'extrémité inférieure de l'humérus, qui
      reçoit la fossette de la tête radiale.`,
    joints: ['Radius, par l’articulation huméro-radiale'],
  },
  'Fosse olécrânienne': {
    what: `La dépression profonde de la face postérieure de la palette
      humérale, qui reçoit l'olécrâne en extension complète.`,
    note: `Sa profondeur limite l'extension. Son comblement, après une
      fracture, donne un flessum du coude.`,
  },

  'Tête radiale': {
    what: `Le disque cylindrique de l'extrémité supérieure du radius, creusé
      d'une fossette et entouré d'une circonférence articulaire.`,
    joints: ['Capitulum de l’humérus, par la fossette',
      'Incisure radiale de l’ulna, par la circonférence'],
    note: `Elle tourne dans le ligament annulaire : chez l'enfant elle peut en
      sortir par traction sur le bras — la pronation douloureuse.`,
  },
  'Col du radius': {
    what: `Le rétrécissement entre la tête et la tubérosité radiale.`,
    near: ['Nerf interosseux postérieur, qui contourne le col dans le supinateur'],
  },
  'Tubérosité radiale (bicipitale)': {
    what: `La saillie ovalaire de la face médiale du radius, sous le col.`,
    muscles: ['Biceps brachial, qui s’y termine'],
    note: 'C’est par elle que le biceps fait la supination, en déroulant le radius.',
  },
  'Processus styloïde radial': {
    what: `La pointe qui descend de l'extrémité distale du radius, du côté du
      pouce.`,
    near: ['Tabatière anatomique, dont il forme le bord proximal'],
    note: `Il descend un centimètre plus bas que le styloïde ulnaire : l'index
      radio-ulnaire, qu'une fracture de Pouteau-Colles inverse.`,
  },
  'Tubercule dorsal (de Lister)': {
    what: `Une petite crête de la face dorsale de l'extrémité distale du
      radius.`,
    through: ['Tendon du long extenseur du pouce, qui s’y réfléchit'],
    note: 'C’est une poulie : le tendon peut s’y rompre après une fracture du poignet.',
  },
  'Incisure ulnaire du radius': {
    what: `La facette concave de la face médiale de l'extrémité distale du
      radius, qui reçoit la tête ulnaire.`,
    joints: ['Tête ulnaire, par l’articulation radio-ulnaire distale'],
  },

  Olécrâne: {
    what: `La grosse apophyse qui coiffe l'extrémité supérieure de l'ulna en
      arrière, et qui fait la pointe du coude.`,
    muscles: ['Triceps brachial, qui s’y termine'],
    joints: ['Fosse olécrânienne de l’humérus, en extension'],
    note: `Sa fracture est une fracture articulaire par choc direct, et le
      triceps écarte les fragments.`,
  },
  'Processus coronoïde de l’ulna': {
    what: `La saillie antérieure de l'extrémité supérieure de l'ulna, qui forme
      avec l'olécrâne l'incisure trochléaire.`,
    joints: ['Fosse coronoïdienne de l’humérus, en flexion'],
    muscles: ['Brachial, sur la tubérosité juste en dessous'],
  },
  'Incisure trochléaire': {
    what: `La grande cavité sigmoïde : la surface en crochet, entre l'olécrâne
      et le processus coronoïde, qui embrasse la trochlée humérale.`,
    joints: ['Trochlée humérale'],
    note: 'C’est elle qui fait du coude une charnière et non une énarthrose.',
  },
  'Incisure radiale de l’ulna': {
    what: `La petite cavité sigmoïde : la facette latérale du processus
      coronoïde, qui reçoit la circonférence de la tête radiale.`,
    joints: ['Tête radiale, par l’articulation radio-ulnaire proximale'],
  },
  'Tubérosité ulnaire': {
    what: `La rugosité de la face antérieure de l'ulna, sous le processus
      coronoïde.`,
    muscles: ['Brachial, qui s’y termine'],
  },
  'Tête ulnaire': {
    what: `L'extrémité distale de l'ulna, arrondie et petite — l'inverse du
      radius, gros en bas et petit en haut.`,
    joints: ['Incisure ulnaire du radius', 'Disque articulaire du poignet'],
    note: 'Elle ne touche pas le carpe : le disque articulaire les sépare.',
  },
  'Processus styloïde ulnaire': {
    what: `La pointe médiale et postérieure de la tête ulnaire.`,
    note: `Son arrachement accompagne souvent une fracture du radius distal, et
      signale une lésion du complexe fibro-cartilagineux triangulaire.`,
  },
...
NOTES.main = {
  'Tubercule du scaphoïde': {
    what: `La saillie palmaire et distale du scaphoïde, palpable à la base de
      l'éminence thénar quand le poignet est en extension.`,
    muscles: ['Rétinaculum des fléchisseurs', 'Court abducteur du pouce'],
    note: `C'est l'un des quatre piliers du canal carpien — avec le tubercule
      du trapèze en dehors, le pisiforme et l'hamulus en dedans.`,
  },
  'Tubercule du trapèze': {
    what: `La crête palmaire du trapèze, en dehors du sillon du fléchisseur
      radial du carpe.`,
    muscles: ['Rétinaculum des fléchisseurs', 'Opposant du pouce'],
    note: 'Deuxième pilier latéral du canal carpien.',
  },
  'Hamulus de l’hamatum (crochet)': {
    what: `Le crochet recourbé de la face palmaire de l'hamatum, palpable dans
      l'éminence hypothénar.`,
    muscles: ['Rétinaculum des fléchisseurs', 'Opposant du cinquième doigt'],
    near: ['Canal de Guyon, dont il forme le bord latéral',
      'Branche profonde du nerf ulnaire, qui le contourne'],
    note: `Sa fracture est classique chez le golfeur et le joueur de tennis, et
      elle peut rompre les tendons fléchisseurs du cinquième doigt.`,
  },
  'Tête du capitatum': {
    what: `L'extrémité proximale arrondie du capitatum, qui s'emboîte dans la
      concavité du scaphoïde et du lunatum.`,
    joints: ['Scaphoïde et lunatum'],
    note: 'C’est l’axe du carpe : tout le poignet tourne autour d’elle.',
  },
  'Corne postérieure du lunatum': {
    what: `Le bord dorsal du lunatum, plus étroit que son bord palmaire — ce
      qui explique le sens de sa luxation.`,
    note: `Le lunatum se luxe en avant, parce qu'il est en coin, plus large en
      palmaire : c'est la luxation la plus fréquente du carpe.`,
  },
  'Base du premier métacarpien': {
    what: `L'extrémité proximale du métacarpien du pouce, en selle, qui
      s'emboîte sur le trapèze.`,
    joints: ['Trapèze, par l’articulation trapézo-métacarpienne'],
    note: `Sa fracture articulaire est la fracture de Bennett. L'arthrose de
      cette articulation est la rhizarthrose.`,
  },
  'Tête du premier métacarpien': {
    what: `L'extrémité distale du métacarpien du pouce, sous laquelle se
      trouvent les deux sésamoïdes.`,
    joints: ['Phalange proximale du pouce'],
  },
  'Tête du deuxième métacarpien': {
    what: `L'extrémité distale du métacarpien de l'index, qui fait la première
      saillie du poing fermé.`,
    joints: ['Phalange proximale de l’index'],
  },
  'Processus styloïde du troisième métacarpien': {
    what: `La pointe dorsale de la base du troisième métacarpien, sur son bord
      radial.`,
    joints: ['Capitatum'],
    note: 'C’est un repère chirurgical du dos de la main, et un axe de la main.',
  },
  'Tête du troisième métacarpien': {
    what: `L'extrémité distale du métacarpien du majeur, la plus saillante du
      poing fermé.`,
    joints: ['Phalange proximale du majeur'],
  },
  'Tête du quatrième métacarpien': {
    what: `L'extrémité distale du métacarpien de l'annulaire.`,
    joints: ['Phalange proximale de l’annulaire'],
  },
  'Tubérosité du cinquième métacarpien': {
    what: `La saillie de la base du cinquième métacarpien, sur son bord
      ulnaire, palpable au bord de la main.`,
    muscles: ['Extenseur ulnaire du carpe'],
  },
  'Tête du cinquième métacarpien': {
    what: `L'extrémité distale du métacarpien de l'auriculaire.`,
    joints: ['Phalange proximale de l’auriculaire'],
    note: `La fracture de son col est la fracture du boxeur : la tête bascule en
      palmaire et la saillie du poing disparaît.`,
  },
  'Base de la phalange proximale du pouce': {
    what: `L'extrémité proximale de la première phalange du pouce, qui reçoit
      la tête du premier métacarpien.`,
    muscles: ['Court fléchisseur, court abducteur et adducteur du pouce'],
    note: `L'arrachement de son bord ulnaire est la lésion de Stener, le pouce
      du skieur.`,
  },
  'Houppe unguéale du pouce': {
    what: `La tubérosité en fer à cheval de l'extrémité de la phalange distale,
      qui soutient la pulpe et l'ongle.`,
    note: 'C’est elle qui donne à la pulpe sa forme et sa résistance à la pince.',
  },
  'Houppe unguéale de l’index': {
    what: `La tubérosité terminale de la phalange distale de l'index, sous
      l'ongle.`,
    note: `Avec celle du pouce, c'est la surface de la pince fine : la pulpe de
      l'index est la plus richement innervée de la main.`,
  },
  'Houppe unguéale du majeur': {
    what: `La tubérosité terminale de la phalange distale du majeur.`,
  },
  'Houppe unguéale de l’annulaire': {
    what: `La tubérosité terminale de la phalange distale de l'annulaire.`,
  },
  'Houppe unguéale de l’auriculaire': {
    what: `La tubérosité terminale de la phalange distale de l'auriculaire, la
      plus petite de la main.`,
  },
...
NOTES['membre-inf'] = {
  ...
  'Crête iliaque': {
    what: `Le bord supérieur, épais et sinueux, de l'aile iliaque, palpable sur
      toute sa longueur.`,
    muscles: ['Obliques et transverse de l’abdomen', 'Grand dorsal',
      'Carré des lombes', 'Fessiers, sur le versant externe'],
    note: `La ligne joignant les deux crêtes — la ligne de Tuffier — passe par
      L4 : c'est le repère de la ponction lombaire. C'est aussi le site de
      prélèvement de greffon osseux et de ponction de moelle.`,
  },
  'Épine iliaque antéro-supérieure': {
    what: `La pointe antérieure de la crête iliaque, sous la peau, repère de
      surface majeur du bassin.`,
    muscles: ['Sartorius', 'Tenseur du fascia lata', 'Ligament inguinal'],
    note: `Le point de McBurney est à l'union du tiers externe et des deux
      tiers internes de la ligne qui la joint à l'ombilic.`,
  },
  'Épine iliaque antéro-inférieure': {
    what: `La saillie juste au-dessus du rebord acétabulaire, en avant.`,
    muscles: ['Droit fémoral, par son tendon direct'],
  },
  'Épine iliaque postéro-supérieure': {
    what: `L'extrémité postérieure de la crête iliaque, marquée à la peau par
      une fossette.`,
    joints: ['Sacrum, en dedans, par l’articulation sacro-iliaque'],
    note: 'Les deux fossettes encadrent le losange de Michaelis.',
  },
  Acétabulum: {
    what: `La cavité hémisphérique de la face latérale de l'os coxal, formée
      par la soudure en Y de l'ilium, de l'ischium et du pubis.`,
    joints: ['Tête fémorale, par l’articulation coxo-fémorale'],
    relief: ['Surface semi-lunaire, articulaire', 'Arrière-fond, non articulaire',
      'Incisure acétabulaire, en bas'],
    note: `Elle couvre plus de la moitié de la tête, contrairement à la glène :
      la hanche est stable et l'épaule ne l'est pas. Son arthrose est la
      coxarthrose.`,
  },
  'Tubérosité ischiatique': {
    what: `La grosse saillie de la partie basse de l'ischium, sur laquelle on
      s'assoit.`,
    muscles: ['Ischio-jambiers : biceps fémoral, semi-tendineux, semi-membraneux',
      'Grand adducteur, par sa portion ischio-condylaire',
      'Ligament sacro-tubéral'],
    note: 'Sa bursite est la douleur fessière du cycliste.',
  },
  'Épine ischiatique': {
    what: `La pointe qui sépare la grande de la petite incisure ischiatique,
      sur le bord postérieur de l'os.`,
    muscles: ['Ligament sacro-épineux', 'Élévateur de l’anus, par l’arc tendineux'],
    near: ['Nerf pudendal, qui la contourne'],
    note: `C'est le repère du bloc pudendal, et le point de mesure du détroit
      moyen en obstétrique.`,
  },
  'Tubercule pubien': {
    what: `La petite saillie du bord supérieur du pubis, à deux ou trois
      centimètres de la symphyse.`,
    muscles: ['Ligament inguinal, qui s’y termine'],
    note: `C'est le repère qui distingue les hernies : une hernie inguinale est
      au-dessus et en dedans, une hernie crurale au-dessous et en dehors.`,
  },
  'Symphyse pubienne': {
    what: `L'articulation médiane et fibro-cartilagineuse entre les deux os
      coxaux, en avant du bassin.`,
    joints: ['Os coxal opposé'],
    note: `Elle se relâche en fin de grossesse sous l'effet de la relaxine, ce
      qui élargit le bassin de quelques millimètres.`,
  },

  'Tête fémorale': {
    what: `Les deux tiers d'une sphère, orientés en haut, en dedans et un peu
      en avant, creusés de la fovéa.`,
    joints: ['Acétabulum'],
    through: ['Ligament rond, dans la fovéa, avec son artère'],
    note: `Son sang vient surtout des artères circonflexes le long du col ;
      l'artère du ligament rond n'y suffit pas. C'est pourquoi une fracture du
      col chez le sujet âgé donne une nécrose de la tête.`,
  },
  'Col fémoral': {
    what: `Le pont oblique entre la tête et le massif trochantérien, qui fait
      environ cent vingt-cinq degrés avec la diaphyse.`,
    note: `Un angle plus ouvert est une coxa valga, plus fermé une coxa vara.
      Sa fracture est la fracture du sujet âgé, et le trait décide du
      traitement : cervical vrai, prothèse ; trochantérien, ostéosynthèse.`,
  },
  'Grand trochanter': {
    what: `Le massif quadrangulaire latéral, à la jonction du col et de la
      diaphyse, palpable sous la peau.`,
    muscles: ['Moyen et petit fessiers', 'Piriforme', 'Obturateurs et jumeaux, dans la fosse trochantérique'],
    note: 'Sa bursite est la douleur latérale de la hanche du coureur.',
  },
  'Petit trochanter': {
    what: `La saillie conique de la face postéro-médiale, sous le col.`,
    muscles: ['Ilio-psoas, qui s’y termine'],
  },
  'Ligne âpre': {
    what: `La crête rugueuse qui parcourt toute la face postérieure de la
      diaphyse fémorale, à deux lèvres.`,
    muscles: ['Grand fessier et adducteurs, sur la lèvre médiale',
      'Vaste latéral et courte portion du biceps, sur la lèvre latérale'],
    note: 'C’est la seule vraie insertion de la diaphyse : le fémur est lisse partout ailleurs.',
  },
  'Condyle fémoral médial': {
    what: `Le condyle interne, plus long et plus descendant que le latéral, ce
      qui donne au genou son valgus physiologique.`,
    joints: ['Plateau tibial médial', 'Ménisque médial'],
  },
  'Condyle fémoral latéral': {
    what: `Le condyle externe, plus large et plus saillant en avant, ce qui
      retient la patella.`,
    joints: ['Plateau tibial latéral', 'Ménisque latéral'],
  },
  'Épicondyle médial du fémur': {
    what: `La saillie au-dessus du condyle médial.`,
    muscles: ['Ligament collatéral tibial', 'Gastrocnémien médial'],
    note: 'Au-dessus de lui, le tubercule de l’adducteur reçoit le grand adducteur.',
  },
  'Épicondyle latéral du fémur': {
    what: `La saillie au-dessus du condyle latéral.`,
    muscles: ['Ligament collatéral fibulaire', 'Gastrocnémien latéral', 'Poplité'],
  },
  'Fosse intercondylaire': {
    what: `L'échancrure profonde qui sépare les deux condyles en arrière.`,
    through: ['Ligaments croisés antérieur et postérieur'],
    note: `Une échancrure étroite est un facteur de rupture du ligament croisé
      antérieur, et elle est élargie pendant la ligamentoplastie.`,
  },
  'Surface patellaire (trochlée fémorale)': {
    what: `La gorge antérieure entre les deux condyles, dans laquelle la
      patella coulisse.`,
    joints: ['Patella'],
    note: `Une trochlée plate — la dysplasie trochléenne — est la cause
      principale de la luxation récidivante de la patella.`,
  },
  'Base de la patella': {
    what: `Le bord supérieur, large, de la patella.`,
    muscles: ['Tendon du quadriceps fémoral'],
  },
  'Apex de la patella': {
    what: `La pointe inférieure de la patella.`,
    muscles: ['Ligament patellaire, vers la tubérosité tibiale'],
    note: 'Sa tendinopathie est le jumper’s knee.',
  },

  'Plateau tibial': {
    what: `La face supérieure élargie du tibia, à deux surfaces glénoïdes
      séparées par l'éminence intercondylaire.`,
    joints: ['Condyles fémoraux, par l’intermédiaire des ménisques'],
    note: 'Sa fracture est une fracture articulaire : tout enfoncement doit être relevé.',
  },
  'Éminence intercondylaire (épines tibiales)': {
    what: `La double saillie entre les deux surfaces glénoïdes du plateau
      tibial.`,
    muscles: ['Ligaments croisés et cornes méniscales, sur les aires en avant et en arrière'],
    note: `Chez l'enfant, le croisé antérieur s'arrache avec un fragment osseux
      de l'épine plutôt que de se rompre.`,
  },
  'Condyle tibial médial': {
    what: `La moitié médiale du plateau tibial, dont la surface est concave.`,
    joints: ['Condyle fémoral médial'],
  },
  'Condyle tibial latéral': {
    what: `La moitié latérale du plateau tibial, dont la surface est plutôt
      convexe — ce qui la rend moins stable.`,
    joints: ['Condyle fémoral latéral', 'Tête fibulaire, en arrière et en dehors'],
  },
  'Tubérosité tibiale': {
    what: `La saillie antérieure sous le plateau, à deux centimètres de
      l'interligne.`,
    muscles: ['Ligament patellaire, qui s’y termine'],
    note: `Son apophysose chez l'adolescent sportif est la maladie
      d'Osgood-Schlatter.`,
  },
  'Tubercule de Gerdy': {
    what: `Le petit relief antéro-latéral du condyle tibial latéral.`,
    muscles: ['Tractus ilio-tibial, qui s’y termine', 'Tibial antérieur'],
    note: 'C’est le repère du ligament antéro-latéral dans la chirurgie du croisé.',
  },
  'Crête tibiale': {
    what: `Le bord antérieur tranchant du tibia, sous-cutané de haut en bas.`,
    note: `C'est parce qu'elle est sous-cutanée que les fractures de jambe sont
      si souvent ouvertes.`,
  },
  'Malléole médiale': {
    what: `Le prolongement descendant du tibia, qui forme la joue interne de la
      mortaise de la cheville.`,
    joints: ['Talus'],
    muscles: ['Ligament collatéral médial (deltoïdien)'],
    note: `Elle descend moins bas que la latérale, ce qui explique que
      l'entorse se fasse en varus.`,
  },
  'Tête fibulaire': {
    what: `L'extrémité supérieure de la fibula, sous le condyle tibial latéral,
      palpable sous la peau.`,
    joints: ['Condyle tibial latéral, par l’articulation tibio-fibulaire proximale'],
    muscles: ['Biceps fémoral', 'Ligament collatéral fibulaire'],
  },
  'Col de la fibula': {
    what: `Le rétrécissement sous la tête fibulaire.`,
    near: ['Nerf fibulaire commun, qui le contourne juste sous la peau'],
    note: `C'est le nerf le plus exposé du membre inférieur : un plâtre trop
      serré ou une jambe croisée trop longtemps donne le pied tombant.`,
  },
  'Malléole latérale': {
    what: `L'extrémité distale de la fibula, qui forme la joue externe de la
      mortaise et descend plus bas que la médiale.`,
    joints: ['Talus', 'Tibia, par l’articulation tibio-fibulaire distale'],
    muscles: ['Ligament collatéral latéral : talo-fibulaires antérieur et postérieur, calcanéo-fibulaire'],
    note: `Le faisceau talo-fibulaire antérieur est le premier rompu dans
      l'entorse en varus, la plus fréquente des lésions traumatiques.`,
  },
...
NOTES.pied = {
  'Tubérosité calcanéenne': {
    what: `La grosse saillie postérieure du calcanéus, qui forme le talon et
      porte l'appui postérieur de la voûte.`,
    muscles: ['Tendon calcanéen (d’Achille)', 'Aponévrose plantaire',
      'Court fléchisseur des orteils', 'Abducteur de l’hallux'],
    note: `L'enthésopathie de l'aponévrose à ce niveau est la fasciite
      plantaire, et l'épine calcanéenne en est la traduction radiologique.`,
  },
  'Sustentaculum tali': {
    what: `L'étagère osseuse de la face médiale du calcanéus, qui soutient le
      col du talus.`,
    joints: ['Talus, par la facette moyenne'],
    near: ['Tendon du long fléchisseur de l’hallux, dans son sillon en dessous'],
    note: 'On le palpe un travers de doigt sous la malléole médiale.',
  },
  'Sillon du long fibulaire, sur le calcanéus': {
    what: `La gouttière de la face latérale du calcanéus, sous la trochlée
      fibulaire, où passe le tendon du long fibulaire.`,
    through: ['Tendon du long fibulaire'],
  },
  'Trochlée du talus': {
    what: `La poulie supérieure du talus, plus large en avant qu'en arrière,
      qui s'emboîte dans la mortaise tibio-fibulaire.`,
    joints: ['Tibia et fibula, par l’articulation talo-crurale'],
    note: `Parce qu'elle est plus large en avant, la cheville est verrouillée
      en flexion dorsale et lâche en flexion plantaire — c'est en flexion
      plantaire qu'on se tord le pied.`,
  },
  'Tête du talus': {
    what: `L'extrémité antérieure et arrondie du talus, qui s'articule avec
      l'os naviculaire.`,
    joints: ['Os naviculaire', 'Sustentaculum tali, en dessous'],
  },
  'Col du talus': {
    what: `Le rétrécissement entre la tête et le corps du talus, la seule
      partie non recouverte de cartilage.`,
    note: `C'est par le col qu'arrive presque tout le sang du talus, et de
      distal vers proximal : une fracture du col nécrose le corps.`,
  },
  'Processus postérieur du talus': {
    what: `La saillie postérieure du talus, creusée d'un sillon entre ses deux
      tubercules.`,
    through: ['Tendon du long fléchisseur de l’hallux'],
    note: `Un os trigone — un tubercule resté séparé — donne le conflit
      postérieur de la cheville chez la danseuse.`,
  },
  'Tubérosité de l’os naviculaire': {
    what: `La saillie médiale de l'os naviculaire, palpable en avant et en
      dessous de la malléole médiale.`,
    muscles: ['Tibial postérieur, qui s’y termine'],
    note: `C'est le repère de l'arche médiale : sa descente signe la
      défaillance du tibial postérieur et le pied plat de l'adulte.`,
  },
  'Sillon du tendon du long fibulaire': {
    what: `La gouttière de la face plantaire du cuboïde, qui renvoie le tendon
      du long fibulaire vers le bord médial du pied.`,
    through: ['Tendon du long fibulaire'],
    note: `C'est ici que le tendon change de direction pour traverser la
      plante : avec le tibial postérieur il forme l'étrier de la voûte.`,
  },
  'Face plantaire du cunéiforme médial': {
    what: `La base du cunéiforme médial, qui regarde la plante — à l'inverse
      des deux autres cunéiformes, dont la base est dorsale.`,
    note: `C'est cette inversion qui donne à la rangée sa forme en coin et
      construit la voûte transversale.`,
  },
  'Base du premier métatarsien': {
    what: `L'extrémité proximale du métatarsien de l'hallux, articulée au
      cunéiforme médial.`,
    muscles: ['Long fibulaire et tibial antérieur'],
  },
  'Tête du premier métatarsien': {
    what: `L'extrémité distale du métatarsien de l'hallux, qui porte deux
      sésamoïdes sur sa face plantaire.`,
    joints: ['Phalange proximale de l’hallux'],
    note: `C'est le point d'appui antéro-médial du pied, et la saillie de
      l'hallux valgus.`,
  },
  'Base du deuxième métatarsien': {
    what: `L'extrémité proximale du deuxième métatarsien, encastrée en
      mortaise entre les trois cunéiformes.`,
    note: `Ce verrou fait de la deuxième colonne la plus rigide du pied — et la
      plus exposée à la fracture de fatigue du marcheur.`,
  },
  'Tête du deuxième métatarsien': {
    what: `L'extrémité distale du deuxième métatarsien.`,
    note: 'Sa nécrose est la maladie de Freiberg.',
  },
  'Tête du troisième métatarsien': {
    what: `L'extrémité distale du troisième métatarsien.`,
  },
  'Tête du quatrième métatarsien': {
    what: `L'extrémité distale du quatrième métatarsien.`,
    note: `Le névrome de Morton siège entre les têtes des troisième et
      quatrième métatarsiens.`,
  },
  'Tubérosité du cinquième métatarsien': {
    what: `La saillie de la base du cinquième métatarsien, sur le bord latéral
      du pied, facilement palpable.`,
    muscles: ['Court fibulaire'],
    note: `Son arrachement par le court fibulaire lors d'une entorse en varus
      est la fracture de Jones : elle se confond avec une simple entorse et
      consolide mal.`,
  },
  'Tête du cinquième métatarsien': {
    what: `L'extrémité distale du cinquième métatarsien, appui antéro-latéral
      du pied.`,
    note: 'Sa saillie médiale est le quintus varus, le bunionette.',
  },
  'Base de la phalange proximale de l’hallux': {
    what: `L'extrémité proximale de la première phalange du gros orteil.`,
    muscles: ['Court fléchisseur, abducteur et adducteur de l’hallux'],
  },
  'Houppe unguéale de l’hallux': {
    what: `La tubérosité terminale de la phalange distale du gros orteil, large
      et aplatie.`,
  },
...
NOTES.thorax = {
  'Incisure jugulaire (fourchette sternale)': {
    what: `L'échancrure du bord supérieur du manubrium, entre les deux
      articulations sterno-claviculaires. Elle se palpe à la base du cou.`,
    near: ['Trachée, juste en arrière', 'Crosse de l’aorte, plus bas'],
    note: `Elle se projette en regard du disque T2-T3, et c'est le repère
      supérieur du médiastin et le point de repère de la trachéotomie.`,
  },
  'Incisure claviculaire': {
    what: `La facette ovalaire de l'angle supéro-latéral du manubrium, qui
      reçoit l'extrémité sternale de la clavicule.`,
    joints: ['Clavicule, par l’articulation sterno-claviculaire'],
  },
  'Angle sternal (de Louis)': {
    what: `La saillie transversale de la jonction entre le manubrium et le
      corps du sternum, palpable à travers la peau.`,
    joints: ['Cartilage de la deuxième côte, exactement à ce niveau'],
    note: `C'est LE repère du thorax : disque T4-T5, bifurcation trachéale,
      début et fin de la crosse de l'aorte, limite des médiastins supérieur et
      inférieur, et le point d'où l'on compte les espaces intercostaux.`,
  },
  'Jonction xipho-sternale': {
    what: `La symphyse entre le corps du sternum et le processus xiphoïde, en
      regard du disque T9.`,
    note: 'C’est la limite supérieure de l’appui du massage cardiaque.',
  },
  'Pointe du processus xiphoïde': {
    what: `L'extrémité inférieure du sternum, cartilagineuse longtemps, de
      forme très variable.`,
    muscles: ['Diaphragme', 'Droit de l’abdomen', 'Ligne blanche'],
    note: 'Comprimer dessus pendant un massage cardiaque le fracture et peut déchirer le foie.',
  },
  'Tubercule du scalène antérieur': {
    what: `La saillie de la face supérieure de la première côte, sur laquelle
      se termine le scalène antérieur.`,
    muscles: ['Scalène antérieur'],
    note: `Il sépare les deux sillons : la veine subclavière passe en avant de
      lui, l'artère et le plexus brachial en arrière. C'est le repère du
      défilé thoraco-brachial.`,
  },
  'Sillon de la veine subclavière': {
    what: `La gouttière de la face supérieure de la première côte, en avant du
      tubercule du scalène antérieur.`,
    through: ['Veine subclavière'],
  },
  'Sillon de l’artère subclavière': {
    what: `La gouttière de la face supérieure de la première côte, en arrière
      du tubercule du scalène antérieur.`,
    through: ['Artère subclavière', 'Tronc inférieur du plexus brachial'],
    note: `Une côte cervicale ou une bride comprime ici le tronc inférieur du
      plexus : c'est le syndrome du défilé.`,
  },
  'Tubérosité du dentelé antérieur': {
    what: `La rugosité de la face externe de la deuxième côte, où s'insère une
      digitation du dentelé antérieur.`,
    muscles: ['Dentelé antérieur'],
  },
  'Sillon costal': {
    what: `La gouttière du bord inférieur de la face interne de la côte, qui
      abrite le paquet vasculo-nerveux intercostal.`,
    through: ['Veine, artère et nerf intercostaux, de haut en bas'],
    note: `VAN de haut en bas : une ponction pleurale se fait au bord SUPÉRIEUR
      de la côte inférieure, jamais sous la côte.`,
  },
  'Extrémité libre de la douzième côte': {
    what: `La pointe antérieure de la douzième côte, flottante, perdue dans la
      paroi abdominale.`,
    near: ['Rein, qu’elle croise en arrière'],
    note: `C'est le repère de la voie d'abord lombaire du rein et le point de
      percussion de la fosse lombaire.`,
  },
  'Centre tendineux du diaphragme': {
    what: `La lame fibreuse en trèfle au sommet de la coupole, où toutes les
      fibres musculaires convergent.`,
    through: ['Hiatus de la veine cave inférieure, à hauteur de T8'],
    note: 'Il ne se contracte pas : c’est sur lui que le muscle tire.',
  },
  'Pilier droit du diaphragme': {
    what: `Le faisceau tendineux qui descend du diaphragme sur les corps
      vertébraux, plus long à droite qu'à gauche.`,
    insertion: ['Corps de L1 à L3, à droite'],
    through: ['Hiatus œsophagien, dans les fibres du pilier — à hauteur de T10'],
  },
  'Pilier gauche du diaphragme': {
    what: `Le pilier gauche, plus court, qui descend jusqu'à L2.`,
    insertion: ['Corps de L1 et L2, à gauche'],
    near: ['Hiatus aortique, entre les deux piliers, à hauteur de T12'],
  },

  'Tête de la première côte': {
    what: `L'extrémité postérieure de la première côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbre T1 seule, par une facette entière'],
  },

  'Angle de la première côte': {
    what: `Le point où la première côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la deuxième côte': {
    what: `L'extrémité postérieure de la deuxième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T1 et T2, par deux demi-facettes'],
  },

  'Angle de la deuxième côte': {
    what: `Le point où la deuxième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la troisième côte': {
    what: `L'extrémité postérieure de la troisième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T2 et T3, par deux demi-facettes'],
  },

  'Angle de la troisième côte': {
    what: `Le point où la troisième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la quatrième côte': {
    what: `L'extrémité postérieure de la quatrième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T3 et T4, par deux demi-facettes'],
  },

  'Angle de la quatrième côte': {
    what: `Le point où la quatrième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la cinquième côte': {
    what: `L'extrémité postérieure de la cinquième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T4 et T5, par deux demi-facettes'],
  },

  'Angle de la cinquième côte': {
    what: `Le point où la cinquième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la sixième côte': {
    what: `L'extrémité postérieure de la sixième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T5 et T6, par deux demi-facettes'],
  },

  'Angle de la sixième côte': {
    what: `Le point où la sixième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la septième côte': {
    what: `L'extrémité postérieure de la septième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T6 et T7, par deux demi-facettes'],
  },

  'Angle de la septième côte': {
    what: `Le point où la septième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la huitième côte': {
    what: `L'extrémité postérieure de la huitième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T7 et T8, par deux demi-facettes'],
  },

  'Angle de la huitième côte': {
    what: `Le point où la huitième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la neuvième côte': {
    what: `L'extrémité postérieure de la neuvième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T8 et T9, par deux demi-facettes'],
  },

  'Angle de la neuvième côte': {
    what: `Le point où la neuvième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la dixième côte': {
    what: `L'extrémité postérieure de la dixième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbres T9 et T10, par deux demi-facettes'],
  },

  'Angle de la dixième côte': {
    what: `Le point où la dixième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la onzième côte': {
    what: `L'extrémité postérieure de la onzième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbre T11 seule'],
  },

  'Angle de la onzième côte': {
    what: `Le point où la onzième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },

  'Tête de la douzième côte': {
    what: `L'extrémité postérieure de la douzième côte, qui s'articule avec le corps
      vertébral. Elle porte deux facettes séparées par une crête, sauf aux
      côtes qui ne rejoignent qu'une seule vertèbre.`,
    joints: ['Vertèbre T12 seule'],
  },

  'Angle de la douzième côte': {
    what: `Le point où la douzième côte change brusquement de direction, un peu en
      dehors du tubercule. C'est la partie la plus postérieure de la côte.`,
    muscles: ['Ilio-costal, qui s’insère sur toute la ligne des angles'],
  },
...
NOTES.colonne = {
  'Fossette costale supérieure de T1': {
    what: `La facette entière du corps de T1 qui reçoit à elle seule la tête de
      la première côte.`,
    joints: ['Première côte'],
    note: `T1 est la seule vertèbre thoracique à porter une facette entière en
      haut : de T2 à T9 la tête d'une côte est partagée entre deux vertèbres.`,
  },
  'Processus épineux de T4': {
    what: `L'épineuse de T4, oblique en bas, en regard du corps de T5.`,
    note: 'Le disque T4-T5 répond à l’angle sternal et à la bifurcation trachéale.',
  },
  'Processus transverse gauche de T6': {
    what: `Le processus transverse d'une vertèbre thoracique moyenne, qui porte
      sur sa face antérieure une fossette costale transversaire.`,
    joints: ['Tubercule de la sixième côte'],
  },
  'Processus épineux de T6': {
    what: `L'épineuse de T6, la plus oblique de toutes : elle se projette en
      regard du corps de T7 ou T8.`,
    note: `C'est ce qui rend le comptage des épineuses trompeur au milieu du
      dos : l'épineuse que l'on palpe n'est pas au niveau de son propre corps.`,
  },
  'Processus épineux de T12': {
    what: `L'épineuse de T12, courte et presque horizontale, déjà de type
      lombal.`,
    note: 'La transition thoraco-lombale se lit sur l’épineuse avant le corps.',
  },
  'Corps vertébral de T12': {
    what: `Le corps de la douzième thoracique, à la charnière, en regard de
      l'hiatus aortique du diaphragme.`,
    near: ['Aorte et canal thoracique, qui traversent le diaphragme ici'],
  },
  'Corps vertébral de L1': {
    what: `Le corps de la première lombale, massif et réniforme.`,
    note: `Le cône médullaire s'arrête en L1-L2 : c'est la limite au-dessus de
      laquelle on ne ponctionne jamais. C'est aussi le plan trans-pylorique.`,
  },
  'Processus costiforme gauche de L1': {
    what: `Le long processus transverse d'une vertèbre lombale, qui correspond
      morphologiquement à une côte.`,
    muscles: ['Carré des lombes', 'Psoas', 'Transverse de l’abdomen, par l’aponévrose thoraco-lombale'],
  },
  'Processus épineux de L3': {
    what: `L'épineuse de L3, rectangulaire et horizontale, facilement palpable.`,
    note: 'Les épineuses lombales sont horizontales : on ponctionne entre elles.',
  },
  'Processus épineux de L4': {
    what: `L'épineuse de L4, au niveau de la ligne joignant les deux crêtes
      iliaques.`,
    note: `La ligne de Tuffier passe par L4 : la ponction lombaire se fait en
      L3-L4 ou L4-L5, bien au-dessous du cône médullaire.`,
  },
  'Corps vertébral de L5': {
    what: `Le corps de la cinquième lombale, plus haut en avant qu'en arrière,
      ce qui crée l'angle lombo-sacré.`,
    note: `Le disque L5-S1 est le plus souvent hernié de tout le rachis, et la
      racine comprimée est S1.`,
  },
  'Processus articulaire inférieur gauche de L5': {
    what: `Le processus articulaire qui descend de L5 vers le sacrum, à
      facettes presque frontales à ce niveau.`,
    joints: ['Processus articulaire supérieur de S1'],
    note: `C'est par une fracture de l'isthme entre les deux processus que se
      fait le spondylolisthésis, le glissement de L5 sur le sacrum.`,
  },
  'Promontoire sacré': {
    what: `L'angle saillant du bord antérieur de la base du sacrum, à la
      jonction avec L5.`,
    note: `C'est le repère du détroit supérieur et le point de mesure de
      l'obstétricien : le promonto-rétro-pubien.`,
  },
  'Aile sacrée': {
    what: `La surface triangulaire latérale de la base du sacrum, de part et
      d'autre du promontoire.`,
    muscles: ['Psoas et iliaque, qui passent devant'],
    near: ['Tronc lombo-sacré, qui descend sur elle vers le pelvis'],
  },
  'Crête sacrée médiane': {
    what: `La crête verticale de la face dorsale du sacrum, faite des processus
      épineux soudés.`,
  },
  'Hiatus sacré': {
    what: `L'ouverture inférieure du canal sacré, due à l'absence de fusion des
      lames de S5, encadrée par les deux cornes sacrées.`,
    through: ['Racines sacrées basses et filum terminal'],
    note: 'C’est la voie d’abord de l’anesthésie caudale.',
  },
  'Surface auriculaire': {
    what: `La surface en oreille de la face latérale du sacrum, qui s'articule
      avec l'os coxal.`,
    joints: ['Os coxal, par l’articulation sacro-iliaque'],
    note: `C'est une articulation très peu mobile, verrouillée par des
      ligaments puissants : elle transmet le poids du corps au bassin.`,
  },
  'Apex du sacrum': {
    what: `L'extrémité inférieure du sacrum, qui s'articule avec la première
      pièce coccygienne.`,
    joints: ['Coccyx'],
  },
  'Cornes coccygiennes': {
    what: `Les deux petites saillies de la première pièce du coccyx, qui
      montent à la rencontre des cornes sacrées.`,
    note: 'Elles encadrent le hiatus sacré et servent à le repérer au doigt.',
  },
  'Pointe du coccyx': {
    what: `L'extrémité inférieure du rachis, palpable au fond du sillon
      inter-fessier.`,
    muscles: ['Ligament ano-coccygien', 'Élévateur de l’anus'],
  },
