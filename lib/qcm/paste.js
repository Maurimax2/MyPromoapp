...
import { straighten } from '../json-paste.js';
...
function asJson(text) {
  ...
  for (const raw of candidates) {
    ...
    const body = trimmed.slice(from, last + 1);
    // As it came, then with the quotes a phone made curly put back straight.
    // A dump of questions pasted from a phone fails exactly the way a dump of
    // lecture numbers does, and for exactly the same reason.
