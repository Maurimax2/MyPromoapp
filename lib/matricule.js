...
//
// D12345. Every student has one, no two students share one, and it is what
...
// moment two of those disagree about whether d12345 is D12345, the number
...
export function matriculeError(raw) {
  ...
  if (!looksRight(value)) return 'رقم جامعي غير صالح — مثال: D12345';
  return null;
}
