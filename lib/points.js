...
export const BADGES = [
  ...
  { id: 'week',    label: 'أسبوع كامل', want: '7 أيام متتالية',      icon: 'flame',  of: (c) => c.longest,  need: 7 },
  { id: 'month',   label: 'شهر كامل',  want: '30 يومًا متتاليًا',    icon: 'flame',  of: (c) => c.longest,  need: 30 },
  { id: 'hundred', label: 'المئة',     want: '100 يوم متتالٍ',       icon: 'crown',  of: (c) => c.longest,  need: 100 },
];
