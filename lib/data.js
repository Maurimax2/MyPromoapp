...
// Subjects whose banner is not named after their id: the same subject in a
// second semester, or in a second year, shares the one drawing.
const ALIAS = {
  'anatomie-s2': 'anatomie',
  'physiologie-s1': 'physiologie',
  'physiologie-s2': 'physiologie',
  'pcem1-anatomie': 'anatomie',
  'pcem1-anatomie-s2': 'anatomie',
  'pcem1-biochimie': 'biochimie',
  'pcem1-biologie': 'biologie',
  'pcem1-embryologie': 'embryologie',
  'pcem1-physiologie-s2': 'physiologie',
};

export const bannerFor = (id) => {
  const name = ALIAS[id] || id;
  return HAVE.has(name) ? `/subjects/${name}-banner.jpg` : null;
};
