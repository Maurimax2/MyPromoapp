...
// Sample feed content, so the screen shows what it does rather than an empty shell.
export const POSTS = [
  {
    id: 'p1', author: 'أحمد محمد', initials: 'أ م', colour: '#6B21B5',
    promo: 'pcem2', field: 'طب', when: 'قبل ساعتين',
    title: 'ملخص فسيولوجيا الكلية',
    body: 'جمعت أهم النقاط في ورقتين. راجعوها وقولوا لي إذا نقص شيء.',
    tag: 'فسيولوجيا', likes: 54, comments: 12,
  },
  {
    id: 'p2', author: 'مريم سيدي', initials: 'م س', colour: '#F97316',
    promo: 'pcem2', field: 'صيدلة', when: 'اليوم 09:40',
    title: 'سؤال حول محاضرة اليوم',
    body: 'ما الفرق بين الأوعية اللمفاوية السطحية والعميقة في الرقبة؟',
    tag: 'تشريح', likes: 23, comments: 7,
  },
  {
    id: 'p3', author: 'يحيى ولد أحمد', initials: 'ي و', colour: '#8B5CF6',
    promo: 'dcem1', field: 'طب', when: 'أمس',
    title: 'ملفان يحملان الرقم 5 في التشريح',
    body: 'الأوعية واللمفاويات كلاهما مرقّم ‎-5-‎ في الدرايف. الصحيح: الأوعية أولًا.',
    tag: 'تشريح', likes: 41, comments: 9,
  },
];
