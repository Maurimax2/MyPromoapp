...
// How long to keep trying before handing the problem back. The route may run
// for a minute; reading a paper takes a good part of that, so the waiting has
// to fit in what is left rather than push the whole thing past its limit.
